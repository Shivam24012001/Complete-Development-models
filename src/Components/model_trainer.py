...
class ModelTrainer:
    ...
    "Gradient Boosting Regressor":{   # ✅ match with model name
    ...
    "XGBoost Regressor":{   # ✅ match with model name
        'learning_rate':[.1,.01,.05,.001],
        'n_estimators': [8,16,32,64,128,256]
    },
    "CatBoost Regressor":{   # ✅ match with model name
        'depth': [6,8,10],
        'learning_rate': [0.01, 0.05, 0.1],
        'iterations': [30, 50, 100]
    },
    "AdaBoost Regressor":{   # ✅ already matches
